...
Login to Application 
    ...
    TypeText           First Name                  Vikrant 2900
    ...
    TypeText           Username                    Vikrant_Automate_9090    anchor=SSN
    TypeText           Password                    Password-9090            anchor=Confirm:
    TypeText           Confirm                     Password-9090
    Sleep              3s
